...
def transform():
    # retrieve parameters from html form
    if 'grayscale' in request.form['mode']:
        mode = 'grayscale'
    elif 'rgbinvert' in request.form['mode']:
        mode = 'rgbinvert'
    else:
        return render_template("error.html", message="Mode not supported (grayscale - rgbinvert)"), 400
    filename = request.form['image']
...
def filters():
    # retrieve parameters from html form
    if 'blur' in request.form['mode']:
        mode = 'blur'
    elif 'emboss' in request.form['mode']:
        mode = 'emboss'
    elif 'contour' in request.form['mode']:
        mode = 'contour'
    elif 'findedges' in request.form['mode']:
        mode = 'findedges'   
    elif 'smooth' in request.form['mode']:
        mode = 'smooth' 
    elif 'sharpen' in request.form['mode']:
        mode = 'sharpen'
    else:
        return render_template("error.html", message="Mode not supported (grayscale - rgbinvert)"), 400
    filename = request.form['image']
